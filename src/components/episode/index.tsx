...
Episode.Container = function EpisodeContainer({
  children,
  ...restProps
}: ComponentProp) {
...
Episode.Header = function EpisodeHeader({
  children,
  ...restProps
}: ComponentProp) {
  return <Header {...restProps}>{children}</Header>;
};
Episode.Title = function EpisodeTitle({
  children,
  ...restProps
}: ComponentProp) {
  return <Title {...restProps}>{children}</Title>;
};
Episode.Dropdown = function EpisodeDropdown({
  seasons,
  season,
  setSeason,
  ...restProps
...
Episode.Panel = function EpisodePanel({
  children,
  ...restProps
}: ComponentProp) {
  return <Panel {...restProps}>{children}</Panel>;
};
Episode.ListItemTitle = function EpisodeListItemTitle({
  children,
  ...restProps
}: ComponentProp) {
  return <ListItemTitle {...restProps}>{children}</ListItemTitle>;
};
Episode.Overview = function EpisodeOverview({
  children,
  ...restProps
}: ComponentProp) {
  return <Overview {...restProps}>{children}</Overview>;
};
Episode.ShowMore = function EpisodeShowMore({
  showAll,
  ...restProps
}: ComponentProp) {
  return (
